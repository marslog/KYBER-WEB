...
export const MARSLOQ_PRESENTATION: PresentationProduct = {
  ...
  showcaseUiSlides: [
    ...
    },
    {
      ...
      imageAlt: "MARSLOQ custom daily canvas report with log severity, hosts, and IP analytics",
      width: 1024,
      height: 716,
    },
    {
      ...
      imageAlt: "MARSLOQ infrastructure overview with service map, load detail, and top hosts",
      width: 1024,
      height: 623,
    },
  ],
